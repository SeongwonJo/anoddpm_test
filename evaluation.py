...
def testing(testing_dataset_loader, diffusion, args, ema, model):
    ...
    for i in [*range(100, args['sample_distance'], 100)]:
        ...
        if args["noise_fn"] == "gauss":
            ...
            out = diffusion.forward_backward(ema, x, see_whole_sequence="half", t_distance=i, denoise_fn="simplex")
...
def main():
    ...
    # testing_dataset_loader = dataset.init_data4eval("../data/chest_xray/test/", args)
    ...
    for i in range(num_iter):
        print("make images..", i+1 ,"/", num_iter)
